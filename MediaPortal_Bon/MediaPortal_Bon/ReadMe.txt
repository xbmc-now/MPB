================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MediaPortal_Bon プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MediaPortal_Bon には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MediaPortal_Bon アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MediaPortal_Bon.vcxproj
...
MediaPortal_Bon.vcxproj.filters
...
MediaPortal_Bon.h
   ...
   CMediaPortal_BonApp アプリケーション クラスを宣言します。

MediaPortal_Bon.cpp
   これは、アプリケーション クラス CMediaPortal_BonApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MediaPortal_Bon.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MediaPortal_Bon.rc に含まれていま
   す。

res\MediaPortal_Bon.rc2
...
MediaPortal_BonDlg.h, MediaPortal_BonDlg.cpp - ダイアログ
   これらのファイルは CMediaPortal_BonDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MediaPortal_Bon.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MediaPortal_Bon.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
