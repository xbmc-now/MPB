================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TstDai プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TstDai には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TstDai アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TstDai.h
   ...
   CTstDaiApp アプリケーション クラスを宣言します。

TstDai.cpp
   これは、アプリケーション クラス CTstDaiApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TstDai.ico
   ...
   アイコンはメイン リソース ファイル TstDai.rc に含まれていま
   す。
...
TstDaiDlg.h, TstDaiDlg.cpp - ダイアログ
   これらのファイルは CTstDaiDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TstDai.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TstDai.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
